 ...
 */
public class ViewComBoChiTiet extends javax.swing.JFrame {

    private DefaultTableModel dtm = new DefaultTableModel();
    private ArrayList<ComBo> listCB = new ArrayList<>();
    private ComBoService nvInter = new ComBoService();

    /**
     * Creates new form ViewSanPhamChiTiet
     */
    public ViewComBoChiTiet() {
        initComponents();
        dtm = (DefaultTableModel) tbBang.getModel();
        listCB=nvInter.getAllComBo();
    ...
    public ComBo getFrom() {
        ...
        ComBo sp = new ComBo(NORMAL, ten, size, TOP_ALIGNMENT, MoTa, trangThai);
        return sp;
    }

    public void detailTableSanPham(int viTri) {
        ComBo sp = listCB.get(viTri);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ComBo chi tiết");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtSize, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        try {
            ...
            Logger.getLogger(ViewComBoChiTiet.class.getName()).log(Level.SEVERE, null, ex);
            
        }
    }//GEN-LAST:event_btnThemActionPerformed

    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        String tenSearch = txtTimKiemComBo.getText();
        List<ComBo> rs = nvInter.search(tenSearch);
        showDataComBo((ArrayList<ComBo>)rs);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        try {
            ...
            if (row != -1) {
                ...
                ComBo updatedSanPham = getFrom();

                // Update the record in the database
                nvInter.update(updatedSanPham, row);
//                nvInter.sua(updatedSanPham, row);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewComBoChiTiet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewComBoChiTiet().setVisible(true);
            }
        });
    }
